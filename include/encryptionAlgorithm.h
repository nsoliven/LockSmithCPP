...
public:
    ...
    Botan::secure_vector<char> hashAndSaltVec(Botan::secure_vector<char> &strToHash, const std::string &salt, const size_t iterations = DEFAULT_ITERATIONS, const size_t keyLength = 32);
};
